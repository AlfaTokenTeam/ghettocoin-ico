...
import "./GHETTOCOIN.sol";

contract GHETTOCOINPreSale {
    GHETTOCOIN public token;
    address public beneficiary;
    uint public amountRaised;
    uint public bonus;

    uint constant public price = 7799399;
    uint constant public minSaleAmount = 50000000000;

    function GHETTOCOINPreSale(
        GHETTOCOIN _token,
        address _beneficiary,
        uint _bonus
    ) {
        token = GHETTOCOIN(_token);
